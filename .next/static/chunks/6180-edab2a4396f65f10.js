...
to {
  ...
  animation: ${Y} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,B=({toast:e})=>{let{icon:t,type:r,iconTheme:n}=e;return void 0!==t?"string"==typeof t?i.createElement(Q,null,t):t:"blank"===r?null:i.createElement(X,null,i.createElement(U,{...n}),"loading"!==r&&i.createElement(W,null,"error"===r?i.createElement(I,{...n}):i.createElement(K,{...n})))},J=e=>`
...
`,en=(e,t)=>{let r=e.includes("top")?1:-1,[n,o]=S()?["0%{opacity:0;} 100%{opacity:1;}","0%{opacity:1;} 100%{opacity:0;}"]:[J(r),ee(r)];return{animation:t?`${_(n)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${_(o)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}};i.memo(({toast:e,position:t,style:r,children:n})=>{let o=e.height?en(e.position||t||"top-center",e.visible):{opacity:0},a=i.createElement(B,{toast:e}),u=i.createElement(er,{...e.ariaProps},M(e.message,e));return i.createElement(et,{className:e.className,style:{...o,...r,...e.style}},"function"==typeof n?n({icon:a,message:u}):i.createElement(i.Fragment,null,a,u))}),a=i.createElement,f.p=void 0,b=a,v=void 0,x=void 0,h`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
