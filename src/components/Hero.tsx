        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:gap-16 gap-5 items-center">
            ...
            <div className="text-center lg:text-left">
              {/* Main Headline */}
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-gray-900 dark:text-white mb-4 leading-tight">
                <div className="text-black text-4xl">Capture.</div>
                <div className="flex text-5xl justify-center md:justify-start bg-gradient-to-r items-center from-blue-500 via-purple-600 to-pink-500 bg-clip-text text-transparent">
                  Create
