...
import { 
  ...
  Shield, Clock, MapPin, Phone, Mail, Calendar,
  Star, TrendingUp, Award, CheckCircle, AlertCircle, X, DollarSign, History
} from 'lucide-react';
            ...
            <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-3 mb-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="text-lg font-bold text-gray-800 dark:text-white">{operator.tasksCompleted}</div>
                </div>
                <div>
                  <div className="text-sm text-indigo-800 dark:text-indigo-300">Efficiency</div>
                  <div className="flex items-center space-x-1">
                    <div className="text-lg font-bold text-gray-800 dark:text-white">{operator.efficiency}%</div>
